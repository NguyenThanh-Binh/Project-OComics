...
export const formatPriceRangeValues = (p1, p2, option = { currency: 'EUR', decimals: 2 }) => {
...
export const clampValue = (value, minRange, maxRange) => {
...
export const formatKpiValue = (value, option = { decimal: 0, minRange: 0 }) => {
    const { decimal, minRange, maxRange, cap, } = option;
...
export const isValueOverCap = (value, cap) => !!(typeof value === 'number' && typeof cap === 'number' && value > cap && cap > 0);
export const isGreaterThan = (threashold, value) => (typeof value === 'number' && value > threashold);
