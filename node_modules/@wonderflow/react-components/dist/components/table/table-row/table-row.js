...
export const TableRow = ({ children, className, expanded, rowData, expandedRows, ...otherProps }) => {
    ...
    return (_jsx("tr", { className: clsx(styles.TableRow, className), "data-table-row-expanded": expanded, "data-table-row-highlight": shouldHighlightRow || undefined, ...otherProps, children: children }));
};
