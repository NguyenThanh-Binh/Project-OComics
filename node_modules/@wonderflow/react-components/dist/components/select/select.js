...
export const Select = forwardRef(({ children, className, invalid = false, disabled = false, icon = 'chevron-down', label, message, kind = 'single', dimension = 'regular', onChange, ...otherProps }, forwardedRef) => {
