...
describe('<DateTime>', () => {
    test(' it should render properly', () => {
        ...
        const { container, getByText } = render(_jsx(Datetime, { date: dt }));
    ...
    test(' it should render properly with local ""it-IT', () => {
        ...
        const { container, getByText } = render(_jsx(Datetime, { date: dt, locale: "it-IT" }));
        expect(getByText(edt)).toBeDefined();
        expect(container).not.toBeNull();
    });
    test(' it should render properly with local ""it-IT and options', () => {
        ...
        const { container, getByText } = render(_jsx(Datetime, { date: dt, locale: "it-IT", options: { year: '2-digit' } }));
        expect(getByText(edt)).toBeDefined();
        expect(container).not.toBeNull();
    });
});
